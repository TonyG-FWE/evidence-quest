...
test('Compact dialogue: full-sized story sentence, useful passage space, word help and both choices',async({page},info)=>{
 ...
 const reading=page.locator('.garden-reading-scroll'),pip=page.locator('[data-source-component="GA.SRC.MARA.6"]'),mara=page.locator('[data-source-component="GA.SRC.MARA.7"]');
