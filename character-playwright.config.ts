...
export default defineConfig({
 testDir:'./character-browser-tests',timeout:90000,expect:{timeout:15000},workers:1,fullyParallel:false,
 outputDir:'output/playwright/character-r2',reporter:[['list'],['json',{outputFile:'evidence/hands-on-20260916/pilot/revision-r2/browser-results.json'}]],
