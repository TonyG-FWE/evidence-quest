...
Group 1 has a completed design; Groups 2–7 have bounded implementation and independent review receipts. Group 8 is verifying the final integrated candidate; check [BUILD-STATUS](../BUILD-STATUS.md) and the [169-item runtime ledger](game-review/GROUPS-1-8-RUNTIME-COVERAGE.md) for current results and remaining qualification. The original audit and older failed playthrough receipts remain preserved. A connected build is not proof of learner improvement or final illustrated-art acceptance.
...
7. **Find Sol helping Rina at her bakery.** Water enters through a cracked tile. Rina has moved the flour sacks away from the puddles and needs dry flour to bake the promised bread. Ask to bring her spare tile, collect it from the shelf, take it to Sol and give it to him. Bridge wood and roof materials have separate purposes and owners.
...
10. **Choose what Sol will share.** His original manuscript stops before the baking and thank-you visit you just witnessed. Write an ending as Sol, using “I” for him, choose a prepared bread or thanks ending, or invite him to bring the draft. **Try my ending** opens a world rehearsal. **Use this ending** separately keeps the exact version for sharing. Rehearsal does not bake more bread or transfer another loaf. Later working edits do not silently replace the chosen version. Child-authored wording and its directly selected picture are explicitly unreviewed while live meaning feedback is unavailable.
...
| World storytelling | **Continue speaking** advances the actual current turn. **Finish this turn** returns to the corresponding conversation. It does not assess whether the child read aloud. |
