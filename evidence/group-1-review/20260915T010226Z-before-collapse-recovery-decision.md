...
Started September 14, 2026 (America/New_York). Updated September 14, 2026, 20:53 EDT (2026-09-15 00:53 UTC). Status: **IN DISCUSSION; SEED ORIGIN, MARA'S ROLE AND BRIDGE MATERIAL SOURCE AGREED; COLLAPSE RECOVERY PROPOSED**.
...
- **G1-RV01:** A first Grandma visit with no Mara page and no Sol visit needs its own truthful report, response to the later-time request, and reason to visit Sol. D015's page-delivery dialogue and D032's already-prepared-Sol opening cannot be reused. Whether the time is agreed on that first visit or the request is carried to later planning needs to be settled with Tony when joining that scene. The numbered outline above does not settle that timing choice.
...
**Status: MATERIAL SOURCE, OWNERSHIP AND INITIAL ACCESS AGREED; RECOVERY STILL OPEN.** Tony replied "Yes, that works." to the shown proposal and the question establishing sections from Grandma's damaged footbridge with her maintenance ropes beside the crossing. This settles the material source and the presented permission/access arrangement. Exact notice wording, placement, manipulation and the collapse/recovery sequence are not completed by this decision. A shared resource rule with the unresolved bakery is not inferred.
...
This choice settles a source and ownership model. It does not approve the full notice wording, exact collection/movement controls, section/post positions or a resolved collapse/recovery scene. The origin of the seed boat, its reason for use and any bakery supplies remain separate open connections.
...
| Ineffective action/recovery | Wrong reach and unsecured crossing retain their existing consequences. Unsecured crossing must visibly collapse, return Pip safely and require rebuilding. How the same pieces/ropes become accessible again remains open; no invisible replacement supply or permanent loss is selected |
...
| Unresolved dependencies | Material source and permission/access arrangement agreed. Exact notice wording, posts, handling, collapse recovery, seed-boat purpose and any bakery material relationship are still open |

The material-source question is settled. The next connected choice concerns the fate and recovery of those same sections and ropes.

## Current issue for Tony: collapse and recovery of the same materials

**Status: PROPOSAL ONLY.** The failure itself is already required. The new decision is whether recovery stays at the crossing or adds a downstream retrieval episode, and how an already-secured end behaves.
...
### Alternatives for the new decision

| Proposal | Effect on the connected adventure |
|---|---|
| **Recommended: recover the same intact sections at the crossing.** | Sections separate and fall into the shallow margins beside the crossing. A correctly fastened rope keeps its section attached to its post; loose sections remain visibly nearby and reachable through construction. The next task is to rebuild and finish the missing fastening work. |
| Add a downstream retrieval episode. | Loose sections drift to another visible, reachable bank location. This adds travel and a recovery/return action, and requires its own accessible path and explanation of how the pieces are brought back. Any correctly tied section should still remain at its post. No downstream episode is selected yet. |

Nearby recovery keeps the cause and remedy together: the loose end allowed the crossing to give way, and rejoining plus the missing fastening makes it usable. The boards and ropes remain usable; failing does not create a search for replacement stock. A secure fastening is proposed to remain secure, so the world retains the difference between work that held and work that was missing.

### Concrete proposed sequence
...
The proposed positions and next actions must cover all three attachment cases, including [independent review G1-RV04](GROUP-1-INDEPENDENT-REVIEW-20260915.md#g1-rv04--retaining-a-fastened-rope-requires-different-recovery-cases). Either bank may be fastened first. References to the near/far section below mean its position in this particular attempted bridge, not a fixed assignment of section identity.

| Before the attempt | Proposed visible state after Pip retreats | Proposed recovery while Pip stays on his bank |
|---|---|---|
...
This proposal keeps collapsed pieces beside the crossing and outside the separate seed-boat channel. A seed already delivered stays with Grandma; a carried seed, letter or story copy remains with Pip. An offer to ask Grandma and Mara's permission remain intact. Collapse does not advance the gathering time, notify anyone, erase story progress or create a compulsory visit to Mara.

### Partial recovery event record

| Field | Proposed detail or existing requirement |
|---|---|
...
Decision needed: whether to use this nearby-recovery sequence, preserving any correctly fastened rope. This is a proposed story/gameplay rule, not an implementation change or an accepted audit result.
