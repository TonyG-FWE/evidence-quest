...
export const roomName=(id:Room['id'])=>({'SC.ST':'Stage','SC.CY':'Courtyard','SC.WK':'Workshop','SC.MD':'Media'})[id];
export function ownerLabel(c:CaseState,id:string):string{
 ...
 const names:Record<string,string>={'ST.MODEL':'Paper model','ST.MODEL.TAB':'Paper tab','ST.SOURCE.E1':'Crew brief','ST.SOURCE.E6':copy('CT.TITLE.E6'),'ST.SOURCE.E4':'Filming request','ST.ACCESS.E2':'Crew message','ST.DOCK':'Loop’s dock','ST.DOCK.FLAP':'Dock flap','ST.DOCK.PAD':'Dock Loop','ST.RACK.BAY':'Story-kit bay','ST.RAIL':'Rehearsal rail','CY.ACCESS.E2':'Crew message','CY.SOURCE.E3':p.objects.noticeFlat?'Courtyard notice':'Curled notice','CY.SOURCE.E7':copy('CT.TITLE.E7'),'WK.ACCESS.NAV':'Venue information','WK.WAYFINDING':'Venue information','WK.TOAST':'Maximum Toast','WK.TOAST.START':'Maximum Toast','WK.TOAST.MAGNIFIER':'Magnifier','MD.SOURCE.E5':'Capture slate','MD.SOURCE.E6':copy('CT.TITLE.E6'),'MD.SOURCE.E7':copy('CT.TITLE.E7'),'MD.ACCESS.E8':'Story kit','KIT.CADDY':'Story kit','KIT.NOTE.E6':copy('CT.TITLE.E6'),'KIT.NOTE.E7':copy('CT.TITLE.E7'),'LOOP.FOLLOW.PAD':'Loop'};
