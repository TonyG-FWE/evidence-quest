...
export function ReadingSession({text,target,origin,speak,onClose,modelNotice,store,onTranscript,title}:{text:string;target:string;title?:string|undefined;origin:DisplayOrigin;speak:(text:string)=>void;onClose:()=>void;modelNotice:string;store:GardenStore;onTranscript?:((text:string)=>void)|undefined}){
