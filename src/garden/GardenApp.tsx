...
export function App(){
 ...
 },[store,s.panel,s.mode,s.cardGesture,s.gesture,s.bakerySelection,s.preview,s.bakeryPreview,c.mara.scene?.preview,s.activity,word,readingTarget,nearMara,nearGrandma,nearSections,nearSol,close,open]);
