...
export function HandControls({s,store}:{s:GardenState;store:GardenStore}){
 ...
 return <aside className="garden-hands" aria-label="Handle nearby objects">
  <p>{gesture?handDefinitions[gesture.object].instruction:'Drag an object, then release to place it. Click a deck or the ground to walk. You can leave a repair unfinished.'}</p>
