...
const gardenFeedback=new GardenFeedbackService();
...
const server=createServer(async(req,res)=>{
  ...
  try{
    ...
    if(path==='/api/garden/config'&&req.method==='GET'){json(200,{content:'garden-chapter-3',textFeedback:gardenFeedback.available,readingFeedback:gardenSpeech.available});return;}
